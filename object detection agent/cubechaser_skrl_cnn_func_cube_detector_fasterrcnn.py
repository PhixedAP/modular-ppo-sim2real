...
env_cfg = load_cfg_from_registry("CCC-skrl-cd-fastercnn-v0", "env_cfg_entry_point")
env = gym.make("CCC-skrl-cd-fastercnn-v0", cfg=env_cfg, asynchronous=False)
...
cfg["experiment"]["directory"] = "runs/torch/CCC-skrl-cd-fastercnn-v0"
...
if training:
    ...
    path = "/home/phil/Documents/24-09-24_08-34-18-330494_PPO/agent_66000.pt"
    agent.load(path)
    trainer.eval()
env.close()