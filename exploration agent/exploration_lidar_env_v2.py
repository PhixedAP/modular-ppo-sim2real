...
@configclass
class ExplorationLidarEnvCfgV2(DirectRLEnvCfg):
    evaluation_mode = True  # used for creating evaluation prints for thesis
    ...
    episode_length_factor = 3.0 if evaluation_mode else 1.5  # TODO: set 3.0 to 1.0 again
    ...
    # laptop: 9 works
    num_envs = 3 if socket.gethostname() == "phil-SCHENKER-MEDIA-E23" else 12  # TODO: set numenvs from 3 to 6 again
    ...
    penalty_for_touching_obstacle = -2.5  # -15.0
...
class ExplorationLidarEnvV2(DirectRLEnv):
    cfg: ExplorationLidarEnvCfgV2
    ...
    def __init__(self, cfg: ExplorationLidarEnvCfgV2, render_mode: str | None = None, **kwargs):
    ...
    def store_occupancy_grid_map_as_png(self, env_id):
        ...
        # also save as pickle
        with open(self.image_path + "occupancy_grid_map_" + str(env_id) + "_" + str(self.observation_counter) + ".pkl", 'wb') as f:
            pickle.dump(ogm_probabilities, f)
    ...
    def store_discovery_percentages_history_env_0_as_png(self):
        ...
        # also save as pickle
        with open(self.image_path + "discovery_percentage_history_" + str(self.observation_counter) + ".pkl", 'wb') as f:
            pickle.dump(self.discovery_percentages_history_env_0, f)
    ...
    def _get_observations(self) -> dict:
        ...
        if self.export_images and self.observation_counter % 25 == 0:
