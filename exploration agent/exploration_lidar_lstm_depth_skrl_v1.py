...
env_cfg = load_cfg_from_registry("Exploration-Lidar-v1", "env_cfg_entry_point")
env = gym.make("Exploration-Lidar-v1", cfg=env_cfg, asynchronous=False)  # try order_enforce? Probably not: If to enforce the order of :meth:`gymnasium.Env.reset` before :meth:`gymnasium.Env.step` and :meth:`gymnasium.Env.render` functions
...
cfg["experiment"]["directory"] = "runs/torch/Exploration-Lidar-Lstm-Depth-v1"
...
if training:
    ...
    path = "/home/phil/Documents/24-12-10_10-14-17-563253_PPO_RNN/agent_221000.pt"  # new best model, no patches, long running
    agent.load(path)
    trainer.eval()
env.close()
