...
class ExplorationAgent:
    ...
    def act(self, observations):
        ...
        return mean_actions, policy[1], value[0], policy[0]  # value[0]
...
class ExploAgentNode:
    ...
    def shutdown(self):
        ...
        rospy.sleep(1)
        print("----------------")
        print(f"min action value (mean, normal): {self.min_action_value} - max action value: {self.max_action_value}")
